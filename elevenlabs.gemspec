...
Gem::Specification.new do |spec|
  ...
  spec.description   = %q{This gem provides a convenient Ruby interface to the ElevenLabs TTS, Voice Cloning, Voice Design, Voice dialogues, TTS Streaming, Music Generation and Streaming endpoints.}
